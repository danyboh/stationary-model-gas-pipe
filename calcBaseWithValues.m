function [p_final_calculated, relative_error_percent, absolute_error]=calcBaseWithValues(lyam, P0_atm, Q, pEnd_atm) % p - Pa
u0=0; uf=122000;
...
[u,y]=ode45(@(u,y) SystRivn_v_2_Danyl(u,y, Qsec,lyam),[u0 uf], y0, options);
