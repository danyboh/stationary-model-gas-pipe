...
B1=-.425468+2.865e-3*T-4.62073e-6*(T^2)+(8.77118e-4-5.56281e-6*T+8.81514e-9*(T^2))*H+(-8.24747e-7+4.31436e-9*T-6.08319e-12*T^2)*H^2;
B2=-.1446+7.4091e-4*T-9.1195e-7*(T^2);
B23=-.339693+1.61176e-3*T-2.04429e-6*(T^2);
B3=-.86834+4.0376e-3*T-5.1657e-6*(T^2);

C1=-.302488+1.95861e-3*T-3.16302e-6*(T^2)+(6.46422e-4-4.22876e-6*T+6.88157e-9*(T^2))*H+(-3.32805e-7+2.2316e-9*T-3.67713e-12*(T^2))*H^2;
